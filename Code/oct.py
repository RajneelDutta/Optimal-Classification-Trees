...
class optimalDecisionTreeClassifier:
    ...
    """
    def __init__(self, max_depth=3, min_samples_split=2, alpha=0, warmstart=False, timelimit=6000, output=True):
    ...
    def predict(self, x):
        ...
        y_pred = []
        for xi in x / self.scales.reshape(1, -1):
            t = 1
            ...
            if t in labelmap:
                ...
                # Skip the current iteration when the key does not exist in the labelmap dictionary
                continue
